...
public class BrowserUtils {
    ...
    /**
     * Switches to new window if there is only two window. OverloadedMethod.
     */
    public static void switchToWindow() {
        ...
        for (String handle : Driver.get().getWindowHandles()) {
            ...
            if (!Driver.get().getWindowHandle().equals(handle)) {
                Driver.get().switchTo().window(handle);
                break;
    ...
    /** V 1.0
     * The method will return the absolute file path to desired document.
     * It will take document name as a string parameter.
     *
     * @param document
     * @return returns the file path as a string
     */

    public static String uploadFile(String document) {
        String src = System.getProperty("user.dir");
        String doc = "src/test/resources/" + document;
        return src + "/" + doc;
    }
